...
public class AutoGenerate {
    ...
    public void genCode() {
        ...
        //设置代码自动生成的文件所存储的路径地址
        gc.setOutputDir(projectPath + "/src/main/java/vo");
        //设置项目作者的名字
        ...
        //设置数据库的访问地址
        dsc.setUrl("jdbc:mysql://124.71.174.130:3306/blog_user?characterEncoding=UTF-8&useSSL=false&useUnicode=true&serverTimezone=UTC");
        //设置数据库驱动配置
